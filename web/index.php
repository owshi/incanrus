...
<div class="site-slider">
    <div class="slider-body">
            ...
            <div class="slide">
                ...
                <img src="<?php bloginfo('template_url'); ?>/assets/img/slide3.jpg" alt="">
...
<section class="welcome-section">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2 class="red-title section-title">Welcome to INCANRUS</h2>
            ...
            <div class="col-md-6">
                <figure class="welcome-image">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/img/welcome.jpg" alt="">
                    </a>
                </figure>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <article class="about-article clearfix">
                    <div class="col-sm-6">
                        <figure class="about-image">
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/director.jpg" alt="">
                        </figure>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="col-md-6">
                <article class="about-article clearfix">
                    <div class="col-sm-6">
                        <figure class="about-image"><img src="<?php bloginfo('template_url'); ?>/assets/img/codirector.jpg" alt="">
                        </figure>
                    </div>
                    <div class="col-sm-6">
                        <div class="about-person">
